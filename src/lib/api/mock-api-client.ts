...
export class MockApiClient {
  private mockUsers: User[] = [
    { id: 1, companyId: 1, username: 'john.doe', name: 'John', surname: 'Alegre', email: 'john.doe@example.com', phoneNumber: '+1234567890', status: 'ACTIVE' },
    ...
    { id: 4, companyId: 1, username: 'carlos.lillo', name: 'Carlos', surname: 'Lillo', email: 'carlos.lillo@example.com', phoneNumber: '+1122374455', status: 'ACTIVE' }
