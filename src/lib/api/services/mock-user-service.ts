...
export class MockUserService implements UserService {
  ...
  async getUserCards(userId: string): Promise<Card[]> {
    // Mock cards data for John Doe (userId: "1")
    if (userId === "1") {
      return Promise.resolve([
        {
          id: 1,
          userId: "1",
          cardNumber: "4532123456785678",
  ...
  async getCardTransactions(cardId: string, userId: string): Promise<Transaction[]> {
    // Mock card transactions with enriched data for John Doe's cards
    if (userId === "1") {
      const baseTransactions = [
        {
          id: 30001,
          transactionId: "CT30001",
          customerId: "1",
          walletId: "1",
          cardId: cardId,
          amount: -45.99,
        ...
        },
        {
          ...
          additionalInfo: {
            ...
            category: "Gas & Fuel",
            geo_location: "Brooklyn, NY, USA",
            mcc: "5542",
            address: "4th Avenue & 9th St",
            payment_type: "CHIP"
          }
        },
        {
          id: 30004,
          transactionId: "CT30004",
          customerId: "1",
          walletId: "1",
          cardId: cardId,
          amount: -89.99,
          ...
          additionalInfo: {
            ...
            geo_location: "Manhattan, NY, USA",
            mcc: "5732",
            address: "Union Square",
            payment_type: "CHIP_PIN"
          }
        },
        {
          id: 30005,
          transactionId: "CT30005",
          customerId: "1",
          walletId: "1",
          cardId: cardId,
          amount: -15.75,
          ...
          transactionType: "PURCHASE",
          additionalInfo: {
            merchant: "Subway Restaurant",
            category: "Food & Beverages",
            geo_location: "Queens, NY, USA",
            mcc: "5814",
            address: "Queensboro Plaza",
            payment_type: "CONTACTLESS"
          }
        },
        {
          id: 30006,
          transactionId: "CT30006",
          customerId: "1",
          walletId: "1",
          cardId: cardId,
          amount: -67.25,
          ...
          additionalInfo: {
            ...
            category: "Retail",
            geo_location: "Bronx, NY, USA",
            mcc: "5310",
            address: "Concourse Plaza",
            payment_type: "CHIP"
          }
        }
      ];
      
      return Promise.resolve(baseTransactions);
    }
    return Promise.resolve([]);
  }
}
