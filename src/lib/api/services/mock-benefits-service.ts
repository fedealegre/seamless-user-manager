...
let mockBenefits: Benefit[] = [
  {
    ...
    estado: 'activo',
    fechaCreacion: new Date('2025-06-01T10:00:00Z'),
    fechaActualizacion: new Date('2025-06-01T10:00:00Z'),
  },
  {
    id: '2',
    code: 'BEN002',
    ...
    fechaFin: new Date('2025-12-31'),
    estado: 'activo',
    fechaCreacion: new Date('2025-06-01T11:00:00Z'),
    fechaActualizacion: new Date('2025-06-01T11:00:00Z'),
  },
  {
    id: '3',
    code: 'BEN003',
    ...
    fechaFin: new Date('2025-12-31'),
    estado: 'activo',
    fechaCreacion: new Date('2025-06-01T12:00:00Z'),
    fechaActualizacion: new Date('2025-06-01T12:00:00Z'),
  },
  {
    id: '4',
    code: 'BEN004',
    ...
    valorPorcentaje: 4,
    topePorCompra: 25000,
    imagen: 'https://images.unsplash.com/photo-1563213126-a4273aed2016?w=400',
    orden: 4,
    categoria: 'Salud',
    mcc: ['5912', '5122'],
    ...
    estado: 'inactivo',
    fechaCreacion: new Date('2025-01-01T13:00:00Z'),
    fechaActualizacion: new Date('2025-01-01T13:00:00Z'),
  },
  {
    id: '5',
    code: 'BEN005',
    ...
    fechaFin: new Date('2025-12-31'),
    estado: 'activo',
    fechaCreacion: new Date('2025-01-01T14:00:00Z'),
    fechaActualizacion: new Date('2025-01-01T14:00:00Z'),
  },
];
