...
export const userTranslations = {
  en: {
    ...
    'new_login': 'New Login',
    'is_pep': 'Is PEP',
    'is_obligated_subject': 'Is Obligated Subject',
    'is_fatca': 'Is FATCA',
    ...
    'address.province.id': 'Province ID',
    'address.locality.id': 'Locality ID',
    'cellphone.number': 'Phone Number',
    'cellphone.area.code': 'Area Code',
    'yes': 'Yes',
    'no': 'No'
  },
  es: {
    ...
    'accounturi': 'URI de Cuenta',
    'full_account_number': 'Número de Cuenta Completo',
    'client_uri': 'URI del Cliente',
    ...
    'new_login': 'Nuevo Acceso',
    'is_pep': 'Es PEP',
    'is_obligated_subject': 'Es Sujeto Obligado',
    'is_fatca': 'Es FATCA',
    'terms_and_conditions': 'Términos y Condiciones',
    'cbu': 'CBU',
    'user_token': 'Token de Usuario',
    'external_ref_id': 'ID de Referencia Externa',
    'deviceinfo': 'Información del Dispositivo',
    'biometric_validation': 'Validación Biométrica',
    'address.province.id': 'ID de Provincia',
    'address.locality.id': 'ID de Localidad',
    'cellphone.number': 'Número de Teléfono',
    'cellphone.area.code': 'Código de Área',
    'yes': 'Sí',
    'no': 'No'
  }
};
